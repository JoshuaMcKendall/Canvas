( function( editor, components, i18n, element ) {
	...
	registerBlockType( 'canvas/profile-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
		...
		edit: function( props ) {
			...
			return [
				...
				el( 'div', { className: props.className },
					el( 'div', {
						className: attributes.mediaID ? 'canvas-profile-image image-active' : 'canvas-profile-image image-inactive',
					...
					el( 'div', {
						className: 'canvas-profile-content', style: { textAlign: alignment } },
						el( RichText, {
							tagName: 'h3',
						...
						el( 'div', { className: 'canvas-profile-social' },
		...
		save: function( props ) {
			...
			return (
				el( 'div', {
					...
					el( 'div', {
						className: 'canvas-profile-image',
					...
					el( 'div', {
						className: 'canvas-profile-content',
						...
						el( 'div', {
							className: 'canvas-profile-social'
						},
							attributes.facebookURL && el( 'a', {
									className: 'social-link',
									href: attributes.facebookURL,
