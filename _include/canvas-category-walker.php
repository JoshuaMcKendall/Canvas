...
// Categories walker
class Canvas_Category_Walker extends Walker_Category {  
    ...
    function __construct($display_count) {
        $this->display_count = (int) $display_count + 1;
    }
    ...
    public function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( ! empty( $args['show_count'] ) ) {
            $link .= ' <span class="ancillary-list-info"><strong>' . number_format_i18n( $category->count ) . '</strong></span>';
        }
        if ( 'list' == $args['style'] ) {
            $output .= "\t<li";
            $css_classes = array(
            ...
            if( empty($category->parent) ) {
                ...
                if( $this->category_count >= $this->display_count ) {

                    $css_classes[] = 'drawer-target';  
            ...
            $output .=  ' class="' . $css_classes . ' list-item"';
            $output .= ">$link\n";
