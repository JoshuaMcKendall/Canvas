...
<div id="buddypress">
	...
	<form action="" method="post" id="blogs-directory-form" class="dir-form">
		...
		<div id="bp-sidebar" class="item-list-tabs column col-xs-12 col-sm-12 col-md-4 col-lg-4" aria-label="<?php esc_attr_e( 'Sites directory main navigation', 'buddypress' ); ?>" role="navigation">
		...
		<div class="item-list-tabs" id="subnav" aria-label="<?php esc_attr_e( 'Sites directory secondary navigation', 'buddypress' ); ?>" role="navigation">
			<ul>
				...
				<li id="blogs-order-select" class="last filter column col-unpadded col-xs-12 col-sm-12 col-md-pull-6 col-lg-pull-6">

					<label class="screen-reader-text" for="blogs-order-by"><?php _e( 'Order By:', 'buddypress' ); ?></label>
					<select id="blogs-order-by" class="form-control">
