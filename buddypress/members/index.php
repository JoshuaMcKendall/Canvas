...
<div id="buddypress" class="row row-unpadded">
	...
	<div id="bp-sidebar" class="column col-xs-12 col-sm-12 col-md-4 col-lg-4">
	...
	<form action="" method="post" id="members-directory-form" class="dir-form column col-xs-12 col-sm-12 col-md-pull-8 col-lg-pull-8">

		<div id="bp-main-section" >
			<div class="item-list-tabs" id="subnav" aria-label="<?php esc_attr_e( 'Members directory secondary navigation', 'buddypress' ); ?>" role="navigation">
				<ul>
					...
					<li id="members-order-select" class="last filter column col-unpadded col-xs-12 col-sm-12 col-md-pull-6 col-lg-pull-6">
	...
	<div id="ancillary-bp-sidebar" class="column col-xs-12 col-sm-12 col-md-4 col-lg-4">

		<?php dynamic_sidebar( 'sidebar-3' ); ?>	

	</div><!-- #ancillary-bp-sidebar -->
