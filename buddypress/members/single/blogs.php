...
<div class="row">
	...
	<div id="blogs-order-select" class="last filter column col-xs-12 col-sm-12 col-md-pull-6 col-lg-pull-5">

		<label for="blogs-order-by" class="bp-screen-reader-text"><?php _e( 'Order By:', 'buddypress' ); ?></label>
