...
<div class="row">
	<div id="members-order-select" class="last filter column col-xs-12 col-sm-12 col-md-pull-6 col-lg-pull-5">
		<?php if ( !bp_is_current_action( 'requests' ) ) : ?>

			<label for="members-friends" class="bp-screen-reader-text"><?php _e( 'Order By:', 'buddypress' ); ?></label>
