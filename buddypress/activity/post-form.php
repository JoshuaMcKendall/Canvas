...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form">
	...
	<div id="whats-new-content">
		<div id="whats-new-textarea">
			...
			<textarea class="bp-suggestions form-control" name="whats-new" id="whats-new" cols="50" rows="10"
				<?php if ( bp_is_group() ) : ?>data-suggestions-group-id="<?php echo esc_attr( (int) bp_get_current_group_id() ); ?>" <?php endif; ?>placeholder="<?php if ( bp_is_group() )
	...
	?>"
		...
		<div id="whats-new-options" class="row row-unpadded">
			<div id="whats-new-submit" class="column">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" class="btn btn-pill btn-primary" value="<?php esc_attr_e( 'Post Update', 'buddypress' ); ?>" />
			</div>

			<?php if ( bp_is_active( 'groups' ) && !bp_is_my_profile() && !bp_is_group() ) : ?>

				<div id="whats-new-post-in-box" class="column col-xs-6 col-sm-6 col-md-4 col-lg-4">
