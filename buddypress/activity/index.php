...
<div id="buddypress">
	...
	<div class="row">
		...
		<div id="bp-sidebar" class="item-list-tabs activity-type-tabs column col-xs-12 col-sm-12 col-md-4 col-lg-4" aria-label="<?php esc_attr_e( 'Sitewide activities navigation', 'buddypress' ); ?>" role="navigation">
				<ul>
					<?php
		...
		<div class="column col-xs-12 col-sm-12 col-md-8 col-lg-8">
			<div class="item-list-tabs no-ajax row row-unpadded" id="subnav" aria-label="<?php esc_attr_e( 'Activity secondary navigation', 'buddypress' ); ?>" role="navigation">
				<ul>
					<?php
					...
					<div id="activity-filter-select" class="last column col-unpadded col-xs-12 col-sm-12 col-md-pull-6 col-lg-pull-6">
			...
			<div class="activity" aria-live="polite" aria-atomic="true" aria-relevant="all">
				...
				<div class="feed">
					<a href="<?php bp_sitewide_activity_feed_link(); ?>" aria-label="<?php esc_attr_e( 'RSS Feed', 'buddypress' ); ?>" class="btn">
						<?php 
